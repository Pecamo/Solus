import { Source, Question, SingleOrMultipleIntents, Intent, IFrameResult, ResultType } from '../types';
...
export class LolWikiaSource implements Source {
    ...
    handleQuestion(question: Question): Promise<Array<IFrameResult>> {
        ...
        let url = LolWikiaSource.host + LolWikiaSource.suffix + page;

        let iframeResult: IFrameResult = {
        ...
        let ret: Array<IFrameResult> = [iframeResult];
